...
df = pd.read_excel("C:/Users/Anushka singh/Desktop/fnd/FakeNewsProject/static/DatasetsUsed/Train.xlsx")
y_train = df['Label']
x_train = df['News']
...
f1 = open("C:/Users/Anushka singh/Desktop/fnd/FakeNewsProject/model.pck", 'rb')
